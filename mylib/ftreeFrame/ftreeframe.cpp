#include "ftreeframe.h"

FtreeFrame::FtreeFrame(QString jsonName ,bool hideKey, QWidget *parent) :QWidget(parent)
{
    // 外框设置
    ...
    button[3]->setText(QString::fromLocal8Bit("--"));
...
//    }
    ...
    // 自动导入tree文件
    file2treeWidget(tree,lineEdit->text());
    setTreeItemIsEditable(tree);    // 允许编辑
}
FtreeFrame::~FtreeFrame()
{
    // 退出时自动导出tree文件
    treeWidget2file(tree,lineEdit->text());
}
// 函数功能:隐藏按键
void FtreeFrame::hide_key(bool hide)
{
    if(hide)frame_hide->hide();
      else  frame_hide->show();
}
// 函数功能:获取文件名
QString FtreeFrame::getJsonName(void)
{
    return lineEdit->text();
}
// 函数功能:查找关键词，并返回对应的item
const QTreeWidgetItem* FtreeFrame::findKeyWord(int column, QString key)
{
...
// 按键触发功能
// 导入json文件
void FtreeFrame::click_button00()
{
...
// 导出json文件
void FtreeFrame::click_button01()
{
...
// 打开文件->用于编辑
void FtreeFrame::click_button02()
{
    QString str1 = "explorer " + lineEdit->text();
    QProcess::execute(str1);
    qDebug()<<"click_button02";
}
void FtreeFrame::click_button03()
{

}
void FtreeFrame::click_button04()
{

}
void FtreeFrame::click_button05()
{

}
void FtreeFrame::click_button06()
{

}
void FtreeFrame::click_button07()
{

}
void FtreeFrame::click_button08()
{

}
//
void FtreeFrame::click_button09()
{

}
//
void FtreeFrame::click_button10()
{

}
void FtreeFrame::click_button11()
{

}
// 当前选择下 新增子层
void FtreeFrame::treeAddChild()
{
    // 判断是否选中
...
// 按下树的单元格
void FtreeFrame::press_tree(QModelIndex index)
{
    // 0.只有右击触发有用
