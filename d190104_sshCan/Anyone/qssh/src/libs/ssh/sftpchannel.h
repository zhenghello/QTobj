...
public:
    ...
    SftpJobId renameFileOrDirectory(const QString &oldPath,   const QString &newPath);
    ...
    SftpJobId uploadFile(QSharedPointer<QIODevice> localFile, const QString &remoteFilePath, SftpOverwriteMode mode);
    SftpJobId uploadFile(const QString &localFilePath,        const QString &remoteFilePath, SftpOverwriteMode mode);
    SftpJobId downloadFile(const QString &remoteFilePath,     const QString &localFilePath, SftpOverwriteMode mode);
    SftpJobId downloadFile(const QString &remoteFilePath,     QSharedPointer<QIODevice> localFile);
    SftpJobId uploadDir(const QString &localDirPath,          const QString &remoteParentDirPath);
    SftpJobId downloadDir(const QString &remoteDirPath,       const QString &localDirPath, SftpOverwriteMode mode);
